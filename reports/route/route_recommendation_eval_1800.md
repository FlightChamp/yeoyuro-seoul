...
- 후보 경로: **324**개
- 출발 조건: (날짜 미지정) / weekday / 18:00 (time_bin 18:00~18:30)
...
|:------------------|-----:|-------:|--------:|---------:|-----------------:|-----------:|
| balanced          |   13 |      2 |   6.231 |    2.154 |            0.361 |         22 |
| calm              |   13 |      2 |   6.231 |    2.154 |            0.347 |         22 |
| fast              |   13 |      2 |   6.231 |    2.154 |            0.325 |         22 |
| min_transfer      |   13 |      2 |   6.231 |    2.154 |            0.374 |         22 |
...
|:-----------|---------------------:|---------------------:|--------------------------------:|----------------------:|------------------------------:|:-----------------------------|
| 신촌->잠실     |                    7 |                    3 |                             3.8 |              nan      |                        0.6394 | False                        |
| 서울역->강남    |                    6 |                    3 |                             0   |              nan      |                        0.2029 | False                        |
| 군자->여의나루   |                    6 |                    2 |                             1.7 |              nan      |                        0.3495 | False                        |
| 한양대->고속터미널 |                    6 |                    3 |                             4.1 |              nan      |                        0.15   | False                        |
| 혜화->사당     |                    6 |                    1 |                             0   |              nan      |                        0.167  | False                        |
| 종각->이태원    |                    6 |                    2 |                             0   |              nan      |                        0.2659 | False                        |
| 건대입구->홍대입구 |                    7 |                    3 |                             3.2 |              nan      |                        0.5916 | False                        |
| 안암->삼성     |                    5 |                    2 |                            18.5 |                1.0922 |                        0.21   | True                         |
| 방화->마천     |                    8 |                    3 |                            42.1 |                1.0069 |                        0.7138 | True                         |
| 응암->고속터미널  |                    5 |                    1 |                             0   |              nan      |                        0.3604 | False                        |
| 신설동->까치산   |                    7 |                    2 |                             0   |              nan      |                        0.5942 | False                        |
...
- 유의미한 대안이 나온 OD쌍: **2/13**
  - 안암->삼성, 방화->마천
- 대안이 없는 OD쌍: **11/13**
  - 신촌->잠실, 서울역->강남, 군자->여의나루, 한양대->고속터미널, 혜화->사당, 종각->이태원, 건대입구->홍대입구, 응암->고속터미널, 신설동->까치산, 연신내->응암, 응암->연신내
...
|:--------------------------|---------:|
| no_meaningful_alternative |      228 |
| primary                   |       52 |
| near_duplicate            |       20 |
| rejected                  |       16 |
| meaningful_alternative    |        8 |
...
|:------------------------|-----------------:|-----------------------:|--------------------------------------:|-----------------:|-----------------------:|
| 한양대->고속터미널|fast         |           1.0549 |                    1.4 |                                   4.1 |                3 |                   12.6 |
| 한양대->고속터미널|calm         |           1.0549 |                    1.4 |                                   4.1 |                3 |                   12.6 |
| 한양대->고속터미널|min_transfer |           1.0549 |                    1.4 |                                   4.1 |                3 |                   12.6 |
| 한양대->고속터미널|balanced     |           1.0549 |                    1.4 |                                   4.1 |                3 |                   12.6 |
| 신촌->잠실|fast             |           1.2406 |                    8.3 |                                   3.8 |                3 |                   10.4 |
...
![pareto](pareto_front_scatter_1800.png)
...
- `route_evaluation_mart` : data\marts\route_evaluation_mart_1800.parquet
- `route_evaluation_summary` : data\marts\route_evaluation_summary_1800.parquet
- `route_eval_cases` : reports\route\route_eval_cases_1800.csv
- `route_eval_summary` : reports\route\route_eval_summary_1800.csv
- `pareto_front_scatter` : reports\route\pareto_front_scatter_1800.png