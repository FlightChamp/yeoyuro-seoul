...
- 후보 경로: **336**개
- 출발 조건: (날짜 미지정) / weekday / 08:30 (time_bin 08:30~09:00)
...
|:------------------|-----:|-------:|--------:|---------:|-----------------:|-----------:|
| balanced          |   13 |      3 |   6.462 |    2.077 |            0.317 |         22 |
| calm              |   13 |      3 |   6.462 |    2.077 |            0.358 |         22 |
| fast              |   13 |      3 |   6.462 |    2.077 |            0.325 |         22 |
| min_transfer      |   13 |      3 |   6.462 |    2.077 |            0.334 |         22 |
...
|:-----------|---------------------:|---------------------:|--------------------------------:|----------------------:|------------------------------:|:-----------------------------|
| 신촌->잠실     |                    7 |                    1 |                             0   |              nan      |                        0.6394 | False                        |
| 서울역->강남    |                    6 |                    4 |                            41.4 |                1.0436 |                        0.02   | True                         |
| 군자->여의나루   |                    6 |                    1 |                             0   |              nan      |                        0.403  | False                        |
| 한양대->고속터미널 |                    7 |                    2 |                             0   |              nan      |                        0.5244 | False                        |
| 혜화->사당     |                    6 |                    1 |                             0   |              nan      |                        0.2549 | False                        |
| 종각->이태원    |                    6 |                    4 |                            35.5 |                1.0444 |                        0.0784 | True                         |
| 건대입구->홍대입구 |                    7 |                    3 |                             6   |              nan      |                        0.5916 | False                        |
| 안암->삼성     |                    5 |                    1 |                             0   |              nan      |                        0.21   | False                        |
| 방화->마천     |                    9 |                    3 |                            58.6 |                1.0655 |                        0.7138 | True                         |
| 응암->고속터미널  |                    6 |                    2 |                            19.9 |              nan      |                        0.3604 | False                        |
| 신설동->까치산   |                    7 |                    2 |                             1.6 |              nan      |                        0.5942 | False                        |
| 연신내->응암    |                    6 |                    2 |                             0   |              nan      |                        0.1444 | False                        |
| 응암->연신내    |                    6 |                    1 |                             0   |              nan      |                        0.1167 | False                        |

- 유의미한 대안이 나온 OD쌍: **3/13**
  - 서울역->강남, 종각->이태원, 방화->마천
- 대안이 없는 OD쌍: **10/13**
  - 신촌->잠실, 군자->여의나루, 한양대->고속터미널, 혜화->사당, 건대입구->홍대입구, 안암->삼성, 응암->고속터미널, 신설동->까치산, 연신내->응암, 응암->연신내
...
|:--------------------------|---------:|
| no_meaningful_alternative |      212 |
| primary                   |       52 |
| meaningful_alternative    |       24 |
| rejected                  |       24 |
| near_duplicate            |       24 |
...
|:-----------------|-----------------:|-----------------------:|--------------------------------------:|-----------------:|-----------------------:|
| 서울역->강남|fast     |           1.4933 |                   14.7 |                                  41.4 |                1 |                    4.6 |
| 서울역->강남|calm     |           1.4933 |                   14.7 |                                  41.4 |                1 |                    4.6 |
| 서울역->강남|balanced |           1.4933 |                   14.7 |                                  41.4 |                1 |                    4.6 |
| 서울역->강남|fast     |           1.1644 |                    4.9 |                                  27.4 |                4 |                   23.3 |
| 서울역->강남|calm     |           1.1644 |                    4.9 |                                  27.4 |                4 |                   23.3 |
...
![pareto](pareto_front_scatter_0830.png)
...
- `route_evaluation_mart` : data\marts\route_evaluation_mart_0830.parquet
- `route_evaluation_summary` : data\marts\route_evaluation_summary_0830.parquet
- `route_eval_cases` : reports\route\route_eval_cases_0830.csv
- `route_eval_summary` : reports\route\route_eval_summary_0830.csv
- `pareto_front_scatter` : reports\route\pareto_front_scatter_0830.png